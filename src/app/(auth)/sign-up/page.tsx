...
function SignUpForm() {
  ...
  return (
    <div className="font-[sans-serif] md:py-[400px] lg:py-[450px] py-32 flex items-center md:h-screen px-5">
        ...
        <div className="grid md:grid-cols-2 lg:gap-24 gap-16 w-full sm:p-8 p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded overflow-hidden">
          ...
          <form className="w-full" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-500 text-white rounded py-3 text-sm font-semibold tracking-wider border-none outline-none hover:bg-blue-600"
